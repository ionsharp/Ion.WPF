...
public class CheckerBrush : DependencyObject
{
    ...
    private static readonly DependencyPropertyKey BrushKey = DependencyProperty.RegisterReadOnly(nameof(Brush), typeof(DrawingBrush), typeof(CheckerBrush), new FrameworkPropertyMetadata(null, null, OnBrushCoerced));
    ...
    private static object OnBrushCoerced(DependencyObject sender, object input)
    {
    ...
    private static void OnPropertyChanged(DependencyObject i, DependencyPropertyChangedEventArgs e) => (i as CheckerBrush).InvalidateProperty(BrushProperty);

    private static DrawingBrush Create(Brush background, Brush foreground, double size)
    {

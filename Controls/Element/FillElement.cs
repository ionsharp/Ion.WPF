...
public class FillElement : Element
{
    ...
    private static object OnCropHeightCoerced(DependencyObject sender, object input) => input is double i && i >= 0 ? i : 0;
    ...
    private static object OnCropWidthCoerced(DependencyObject sender, object input) => input is double i && i >= 0 ? i : 0;
    ...
    private static object OnCropXCoerced(DependencyObject sender, object input) => input is double i && i >= 0 ? i : 0;
    ...
    private static object OnCropYCoerced(DependencyObject sender, object input) => input is double i && i >= 0 ? i : 0;
    ...
    protected override void OnRender(DrawingContext context)
    {
        ...
        Try.Do(() => context.DrawGeometry(Fill, null, result));
    }
}
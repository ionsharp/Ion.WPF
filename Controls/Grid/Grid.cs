...
public static class XGrid
{
    ...
    private static void OnAutoColumnsChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
    {
    ...
    private static void OnAutoRowsChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
    {
        if (sender is Grid grid)
        {
            if ((bool)e.NewValue)
    ...
    static XGrid()
    {
        EventManager.RegisterClassHandler(typeof(Grid), FrameworkElement.SizeChangedEvent,

...
[Extend<System.Drawing.Point>, Extend<Point>]
public static class XPoint
{
    ...
    public static System.Drawing.Point Between(this System.Drawing.Point a, System.Drawing.Point b)
        => new(Convert.ToInt32(Convert.ToDouble(a.X + b.X) / 2.0), Convert.ToInt32(Convert.ToDouble(a.Y + b.Y) / 2.0));
    ...
    public static System.Drawing.Point Int32(this Point a) => new(Convert.ToInt32(a.X), Convert.ToInt32(a.Y));

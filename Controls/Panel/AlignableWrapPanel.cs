...
/// <summary>A <see cref="WrapPanel"/> with alignable content.</summary>
/// <remarks>Borrowed from http://stackoverflow.com/questions/806777/wpf-how-can-i-center-all-items-in-a-wrappanel.</remarks>
public class AlignableWrapPanel : Panel
{
    ...
    private static void OnOrientationChanged(DependencyObject i, DependencyPropertyChangedEventArgs e) => ((AlignableWrapPanel)i).orientation = e.Convert<Orientation>().NewValue;
    ...
    private struct UVSize
    {
        ...
        {
            readonly get { return (orientation == Orientation.Horizontal ? U : V); }
            private set { if (orientation == Orientation.Horizontal) U = value; else V = value; }
        }

        internal double Height
        {
            readonly get { return (orientation == Orientation.Horizontal ? V : U); }

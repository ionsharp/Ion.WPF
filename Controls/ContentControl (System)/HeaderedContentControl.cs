...
public static class XHeaderedContentControl
{
    ...
    public static readonly DependencyProperty HeaderPlacementProperty = DependencyProperty.RegisterAttached("HeaderPlacement", typeof(SideY), typeof(XHeaderedContentControl), new FrameworkPropertyMetadata(SideY.Top));
    public static SideY GetHeaderPlacement(HeaderedContentControl i)
        => (SideY)i.GetValue(HeaderPlacementProperty);
    public static void SetHeaderPlacement(HeaderedContentControl i, SideY input)
    ...
    {
        EventManager.RegisterClassHandler(typeof(HeaderedContentControl), UIElement.MouseLeftButtonDownEvent,
    ...
    private static void OnMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
    {
        ...
        {
            var header = e.OriginalSource.As<DependencyObject>().GetParent<ContentPresenter>(i => ReferenceEquals(XElement.GetName(i), HeaderKey));
            if (header != null)
            {
                switch (e.ClickCount)
                {

...
public abstract class ContentControl<T> : Control
{
    ...
    private static void OnContentChanged(DependencyObject i, DependencyPropertyChangedEventArgs e) => i.As<ContentControl<T>>().OnContentChanged(e);
    ...
    private static void OnContentTemplateChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e) => sender.As<ContentControl<T>>().OnContentTemplateChanged(e);
    ...
    private static void OnContentTemplateSelectorChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e) => sender.As<ContentControl<T>>().OnContentTemplateSelectorChanged(e);

    protected ContentControl() : base() { }

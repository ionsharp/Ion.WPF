...
/// </summary>
public partial class ConsoleBox : RichTextBox, IStorageControl
{
    ...
    private static readonly DependencyProperty ShowDiagnosticsProperty = DependencyProperty.Register("ShowDiagnostics", typeof(bool), typeof(ConsoleBox), new PropertyMetadata(false));

...
/// </remarks>
public static class SingleInstance<TApplication> where TApplication : Application, ISingleApp
{
    #region Classes
    ...
    {
        string[] args = null;
        if (AppDomain.CurrentDomain.ActivationContext is null)
        {
    ...
    private static void ActivateFirstInstance(IList<string> args)
    {
        ...
        ((TApplication)Application.Current).OnReloaded(args);
    }
